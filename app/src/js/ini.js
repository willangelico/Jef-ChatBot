;(function( $ ) {
    ...
    "use strict";
		...
		// Avatars
		var avatar = {
			"robot" : "/arquivos/avatar-robot.png",
			"user" : "/arquivos/avatar-user.png"
		}

		var bootList = () => `
			<img src=${avatar.robot} alt="Avatar Boot" class="img-circle img-responsive">
			<strong>Jefferson</strong>
			<small>Connect Parts - A maior loja de acessórios e som automotivo da América Latina</small>
		`;
		...
		var talk = {"bootConversation":[
			...
			},
			{
				...
				"depType": "select", 
				"depList": "states", 
				"depPlaceholder": "Digite a sigla UF (ex: SP)", 
				"depName": "state",
				"condition": "notEmpty",
				"dialog":"Nós sempre lembramos de presentear nossos clientes em seus aniversários", 
				"nextDialog": "28" 
			},
			{
				"id": 28,
				"dep": false, 
				"dialog":"e o seu não pode passar em branco, ne?",
				"nextDialog": "29"  
			},
			{
				"id": 29,
				"dep": false, 
				"dialog":"E quando vc nasceu?",
				"nextDialog": "30"
			},{ 
				"id": 30, 
				"dep": true, 
				"depType": "input", 
				"depName": "birthday", 
				"depPlaceholder": "Digite a data de nascimento (ex: 10/10/1990)", 
				"condition": "notEmpty", 
				"dialog":"Nossa! :o", 
				"nextDialog": "31" 
			},
			{
				"id": 31,
				"dep": false, 
				"dialog":"Já ia me esquecendo de perguntar, mesmo pq, eu fico meio envergonhado...rs",
				"nextDialog": "32"
			},
			{
				"id": 32,
				"dep": false, 
				"dialog":"Mas vamos lá, vc é menino ou menina?",
				"nextDialog": "33"
			},{ 
				"id": 33, 
				"dep": true, 
				"depType": "multiple", 
				"depName": "sex", 
				"condition":"Feminino|Masculino",
				"dialog":"Pronto! Seu CUPOM já está garantido.|Pronto! Seu CUPOM já está garantido.", 
				"nextDialog": "34|34" 
			},
			{ 
				"id": 34, 
				"dep": false, 
				"dialog":"Agora ,que tal escolher a frequência que vc deseja receber nossas novidades?!",
				"nextDialog": "35"
			},{ 
				"id": 35, 
				"dep": true, 
				"depType": "multiple", 
				"depName": "news", 
				"condition":"Todos os dias|3 Vezes por semana|1 Vez por semana",
				"dialog":"Obrigado pela Confiança.... Você ganhou Frete Grátis na próxima compra! Já estamos enviando um e-mail com Seu Cupom, é só Aproveitar!!!! ;)", 
				"nextDialog": "36" 
			}
		...
		var states = [
			{id: "1", title: "AC"},{id: "2", title: "AL"},{id: "3", title: "AM"},{id: "4", title: "AP"},{id: "5", title: "BA"},{id: "6", title: "CE"},{id: "7", title: "DF"},{id: "8", title: "ES"},{id: "9", title: "GO"},{id: "10", title: "MA"},{id: "11", title: "MT"},{id: "12", title: "MS"},{id: "13", title: "MG"},{id: "14", title: "PA"},{id: "15", title: "PB"},{id: "16", title: "PR"},{id: "17", title: "PE"},{id: "18", title: "PI"},{id: "19", title: "RJ"},{id: "20", title: "RN"},{id: "21", title: "RO"},{id: "22", title: "RS"},{id: "23", title: "RR"},{id: "24", title: "SC"},{id: "25", title: "SE"},{id: "26", title: "SP"},{id: "27", title: "TO"}
		];
